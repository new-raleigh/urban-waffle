...
import { OrganizationRepository } from "./lib/repository"
...
class MyStack extends TerraformStack {
  constructor(scope: Construct, id: string) {
    ...
    new OrganizationRepository(this, "posts", {
      name: "posts-backend",
    ...
    new OrganizationRepository(this, "posts-front-end", {
      name: "posts-frontend",
      tfeOrganization: "new-raleigh",
      tfeToken: process.env.TFE_TOKEN,
      tfeOrganizationToken: process.env.TFE_ORGANIZATION_TOKEN,
    ...
    new OrganizationRepository(this, "auth-back-end", {
      name: "auth-backend",
      tfeOrganization: "new-raleigh",
      tfeToken: process.env.TFE_TOKEN,
      tfeOrganizationToken: process.env.TFE_ORGANIZATION_TOKEN,
